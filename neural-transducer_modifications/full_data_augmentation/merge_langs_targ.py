def merge_files(lang1, lang2, lang3):
    ...
    output_dev = open('task0-data/DEVELOPMENT-LANGUAGES/custom/' + lang1 + "_" + lang2 + "_" + lang3 +  "_targ.dev", "w")
    for ln in dev:
        output_dev.write(ln)
    output_dev.close()
    ...
    output_trn = open('task0-data/DEVELOPMENT-LANGUAGES/custom/' + lang1 + "_" + lang2 + "_" + lang3 + "_targ.trn", "w")
    for ln in trn1:
        output_trn.write(ln)
    for ln in trn2:
        output_trn.write(ln)
    ...
    output_tst = open('task0-data/DEVELOPMENT-LANGUAGES/custom/' + lang1 + "_" + lang2 + "_" + lang3 + "_targ.tst", "w")
    for ln in tst:
        output_tst.write(ln)
    output_tst.close()
