def merge_files(lang1, lang2, lang3, lang4, lang5):
    ...
    output_dev = open('task0-data/DEVELOPMENT-LANGUAGES/custom/' + "all_langs_targ.dev", "w")
    counter = 0
    for ln in dev1:
        output_dev.write(ln)
        counter += 0
    ...
    tr4 = open('task0-data/DEVELOPMENT-LANGUAGES/germanic/' + lang4 + ".trn")
    tr5 = open('task0-data/DEVELOPMENT-LANGUAGES/germanic/' + lang5 + ".trn")
    trn1 = [line for line in tr1]
    trn2 = [line for line in tr2]
    trn3 = [line for line in tr3]
    trn4 = [line for line in tr4]
    trn5 = [line for line in tr5]
    tr1.close()
    tr2.close()
    tr3.close()
    tr4.close()
    ...
    output_trn = open('task0-data/DEVELOPMENT-LANGUAGES/custom/' + "all_langs_targ.trn", "w")
    for ln in trn1:
        output_trn.write(ln)
    for ln in trn2:
        output_trn.write(ln)
    ...
    output_tst = open('task0-data/DEVELOPMENT-LANGUAGES/custom/' + "all_langs_targ.tst", "w")
